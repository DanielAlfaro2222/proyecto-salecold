# Generated by Django 3.2.7 on 2021-10-31 01:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='HeaderOrdered',
            fields=[
                ('id_header_ordered', models.IntegerField(primary_key=True, serialize=False, verbose_name='Id cabecera pedido')),
                ('order_date', models.DateTimeField(auto_now_add=True, verbose_name='Fecha pedido')),
                ('state', models.BooleanField(default=True, verbose_name='Disponible')),
        ...
        migrations.CreateModel(
            name='PaymentType',
            fields=[
                ('id_payment_type', models.IntegerField(primary_key=True, serialize=False, verbose_name='Id tipo de pago')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_type_accounting_document', models.IntegerField(primary_key=True, serialize=False, verbose_name='Id tipo documento contable')),
        ...
        migrations.CreateModel(
            name='TypeOfDelivery',
            fields=[
                ('id_type_of_delivery', models.IntegerField(primary_key=True, serialize=False, verbose_name='Id tipo de entrega')),
                ('description', models.CharField(max_length=45, verbose_name='Descripcion')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='OrderDetail',
            fields=[
                ('id_order_detail', models.IntegerField(primary_key=True, serialize=False, verbose_name='Id detalle pedido')),
